...
\begin{figure}
  \centering
  \includesvg{new media/1_1_blockdiagramm_zur_digitalen_sign.svg}
...
\begin{table}
  ...
  \begin{tabular}{ll}
    \toprule
    \includegraphics[width=2.75591in,height=2.33858in]{new media/1_2_bild_beispiele_fr_systeme_mit_d.jpeg} & \includegraphics[width=2.75591in,height=2.33858in]{new media/1_3_bild_beispiele_fr_systeme_mit_d.jpeg} \\
    \midrule
    c) Field-Programmable-Gate-Array (FPGA) & b) Micro-Controller (µC) und Signalprozessoren (DSP) \\
    \includegraphics[width=2.75591in,height=2.08268in]{new media/1_4_bild_beispiele_fr_systeme_mit_d.jpeg} & \includegraphics[width=2.75591in,height=2.08268in]{new media/1_5_bild_beispiele_fr_systeme_mit_d.jpeg} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{figure}
  \centering
  \includegraphics[alt={Systemtheorie Online (https://eit-mesysto.hs-karlsruhe.de)}]{new media/1_6_systemtheorie_online_httpseitmes.png}
...
\begin{figure}
  \centering
  \includegraphics[alt={Darstellung des Verhaltens eines sogenannten PT2-Gliedes als Silverlight-Applikation}]{new media/1_7_darstellung_des_verhaltens_eines.png}
...
\begin{figure}
  \centering
  \includegraphics[alt={Versuchsaufbau zum Einschwingverhalten eines Lautsprechers}]{new media/1_8_versuchsaufbau_zum_einschwingve.jpeg}
