...
\begin{figure}
  \centering
  \includesvg{./media/1_1_blockdiagramm_zur_digitalen_sign.svg}
...
\begin{table}
  ...
  \begin{tabular}{ll}
    \toprule
    \includegraphics[width=2.75591in,height=2.33858in]{./media/image7.jpeg} & \includegraphics[width=2.75591in,height=2.33858in]{./media/image8.jpeg} \\
    \midrule
    c) Field-Programmable-Gate-Array (FPGA) & b) Micro-Controller (µC) und Signalprozessoren (DSP) \\
    \includegraphics[width=2.75591in,height=2.08268in]{./media/image9.jpeg} & \includegraphics[width=2.75591in,height=2.08268in]{./media/image10.jpeg} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{figure}
  \centering
  \includegraphics[alt={Systemtheorie Online (https://eit-mesysto.hs-karlsruhe.de)}]{./media/1_2_systemtheorie_online_httpseitmes.png}
...
\begin{figure}
  \centering
  \includegraphics[alt={Darstellung des Verhaltens eines sogenannten PT2-Gliedes als Silverlight-Applikation}]{./media/1_3_darstellung_des_verhaltens_eines.png}
...
\begin{figure}
  \centering
  \includegraphics[alt={Versuchsaufbau zum Einschwingverhalten eines Lautsprechers}]{./media/1_4_versuchsaufbau_zum_einschwingve.jpeg}
